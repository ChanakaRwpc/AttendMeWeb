      ...
      <div>
        ...
        >
                ...
                >
                  <div style={{ textAlign: "center" }}>
                    ...
                    <TextField
                      id="outlined-read-only-input"
                      //label="Status"
                      inputProps={{ style: { color: responseData.status_txtcolor } }}
                      defaultValue={responseData.ewo_status}
                      InputProps={{
                        readOnly: true,
                      }}
                      style={{backgroundColor:responseData.status_bckcolor, borderRadius:5}}
                    />
                    <TextField
                      id="outlined-read-only-input"
          ...
          <DialogActions>
            ...
            <Button
             variant="contained" endIcon={<CloseIcon />} color="error"
              autoFocus
              onClick={() => {
                handleScndClose();
                // handleSaveChanges();
